"""First-pass location scan of Walkie Talkie transcripts against an NYC gazetteer."""
import json, re
from collections import Counter

S = 'research/'
raw = json.load(open(S + 'walkie_talkie_raw.json'))
...
json.dump(rows, open(S + 'walkie_talkie_scan.json', 'w'), indent=1)

with open(S + 'walkie_talkie_review.md', 'w') as f:
    f.write('# Walkie Talkie — first-pass location scan\n\n')
